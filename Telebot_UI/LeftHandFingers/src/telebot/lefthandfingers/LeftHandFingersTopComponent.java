 ...
 */
package telebot.lefthandfingers;
 ...
 */
@ConvertAsProperties(
        dtd = "-//telebot.lefthandfingers//LeftHandFingers//EN",
        autostore = false
)
@TopComponent.Description(
        preferredID = "LeftHandFingersTopComponent",
        //iconBase="SET/PATH/TO/ICON/HERE", 
        persistenceType = TopComponent.PERSISTENCE_ALWAYS
)
@TopComponent.Registration(mode = "output", openAtStartup = false)
@ActionID(category = "Window", id = "telebot.lefthandfingers.LeftHandFingersTopComponent")
@ActionReference(path = "Menu/Window" /*, position = 333 */)
@TopComponent.OpenActionRegistration(
        displayName = "#CTL_LeftHandFingersAction",
        preferredID = "LeftHandFingersTopComponent"
)
@Messages({
    "CTL_LeftHandFingersAction=LeftHandFingers",
    "CTL_LeftHandFingersTopComponent=LeftHandFingers Window",
    "HINT_LeftHandFingersTopComponent=This is a LeftHandFingers window"
})
public final class LeftHandFingersTopComponent extends TopComponent {
    ...
    public LeftHandFingersTopComponent() {
        initComponents();
        setName(Bundle.CTL_LeftHandFingersTopComponent());
        setToolTipText(Bundle.HINT_LeftHandFingersTopComponent());
